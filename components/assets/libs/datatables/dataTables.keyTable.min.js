...
(function (f) {
	...
	f.extend(n.prototype, {
		...
		_constructor: function () {
			...
			if (this.c.editor) {
				...
				f(b.table().body()).on("dblclick.keyTable", "th, td",
					function (c) {
		...
		_tabInput: function () {
			var a = this,
				b = this.s.dt,
				c = null !== this.c.tabIndex ? this.c.tabIndex :
		...
		_updateFixedColumns: function (a) {
			...
			if (c._oFixedColumns) {
				...
				(a < c._oFixedColumns.s.iLeftColumns ||
	...
	l.ext.selector.cell.push(function (a, b, c) {
		var b = b.focused,
			...
			d = [];
		if (!a || b === o) return c;
		for (var e = 0, f = c.length; e < f; e++)(!0 === b && a.focused(c[e]) || !1 === b && !a.focused(c[e])) && d.push(c[e]);
		return d
	});
