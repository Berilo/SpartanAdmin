...
! function (a, b, c) {
	...
	a.quicksearch = {
		defaults: {
			...
			testQuery: function (a, b, c) {
				for (var d = 0; d < a.length; d += 1)
					if (b.indexOf(a[d]) === -1) return !1;
				return !0
			}
		},
		...
		return l.noResults = l.noResults ? a(l.noResults) : a(), l.loader = l.loader ? a(l.loader) : a(), this.go = function () {
			...
			for (l.removeDiacritics && (i = k.removeDiacritics(i)), b = l.prepareQuery(i), c = 0, d = g.length; c < d; c++) b.length > 0 && b[0].length < l.minValLength ? (l.show.apply(g[c]), h = !1, e++) : m || l.testQuery(b, f[c], g[c]) ? (l.show.apply(g[c]), h = !1, e++) : l.hide.apply(g[c]);
			return h ? a.isFunction(l.onNoResultFound) ? l.onNoResultFound(this) : this.results(!1) : (this.results(!0), this.stripe()), this.matchedResultsCount = e, this.loader(!1), l.onAfter.call(this), j = i, this
			...
			return l.caseSensitive || (c = c.toLowerCase()), c = a.trim(c)
			...
			return b = "undefined" == typeof b || b, h = a(c).not(l.noResults), f = "string" == typeof l.selector ? h.map(function () {
				return a(this).find(l.selector).map(function () {
		...
		}, this.cache(), this.stripe(), this.loader(!1), this.each(function () {
			a(this).on(l.bind, function (b) {
				if (l.keyCode) {
					var c = b.keyCode || b.which;
					c === l.keyCode && (i = a(this).val(), k.trigger())
				} else i = a(this).val(), k.trigger()
			}), a(this).on(l.resetBind, function () {
				i = "", k.reset()
			})
		})
	}, b.module && b.module.exports && (module.exports = a.fn.quicksearch)
