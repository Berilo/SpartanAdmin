! function (t) {
	...
	e.prototype.init = function () {
		t("#sa-basic").on("click", function () {
			Swal.fire({
				title: "Send invitation for Admin Console",
				imageUrl: "assets/images/logo-dark-spartan.png",
				input: "email",
			...
			Swal.mixin({confirmButtonText: "Next &rarr;",
				showCancelButton: !0,
				progressSteps: ["1", "2"]
			}).queue([{
				title: "Invite to Admin Console",
				text: "Write e-mail of eprson you want to invite",
				input: "email",
			}]).then(function (t) {
				t.value && Swal.fire({
					title: "Asign Scope",
